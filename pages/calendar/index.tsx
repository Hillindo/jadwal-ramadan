...
export default function Page() {
    ...
    <Container fluid bg="#005E6A">
          ...
          <Grid pt={{base:"2px", md:"100px", xl:"20px", lg:"180px"}}>
            <Grid.Col span={{base:12, xl:4, md:6}}>
              <Container pt={{xl:"5px", lg:"0px"}} ml={{xl:"55%", base:"15%"}} pb="10px" w={{xl:"50%", md:"50%", xs:"10%", sm:"10%", lg:"20%" }}>
                <Image fit="contain" mt={{base:"40%", xl:"20%"}} w={{lg:"400%",xl:"120%", base:"80%"}} src="/masjid_petrokimia.webp"/>
              </Container>
              ...
              <Container mt="40px" ml={{xl:"35%", lg:"0%", base:"0%"}} w="100%">
                <Text c="#FFD700" ta="left" ml={{base:"25%",lg:"30%", xl:"30%"}} fw={700} fz={{xl:"28px", base:"19px", lg:"20pt"}}>
                  Jadwal Imsakiyah <br/>
                </Text>
                <Text pt={{xl:"2%", base:"0%", lg:"2%"}}c="#FFD700" ta="left" ml={{base:"27%",lg:"30%", xl:"32%"}} fw={300} fz={{xl:"28px", base:"19px", lg:"20pt"}}>
                  Ramadan 1445H
                </Text>
              </Container>
            </Grid.Col>
      ...
      <Container w="100%" mt={{xl:"4%"}}>
        ...
        <a href="https://www.instagram.com/petrokimiagresik_official?igsh=eGI5eHVscDhtNzJl&utm_source=qr"><Image fit="contain" w={{base:"20px", xl:"30px"}} ml={{xl:"10%"}} c="white"src="/instagram.png"/></a>
        <Text ml="10px" mt="4px" c="white" ta="center"> Petrokimia</Text>
        <a href="www.petrokimia-gresik.com"><Image fit="contain" w={{base:"20px", xl:"30px"}} ml="15px" src="/browser.png" /></a>
        <a href="www.petrokimia-gresik.com"><Text ml="10px" mt="5px" c="white" ta="center"> www.petrokimia-gresik.com</Text></a>
        </Flex>
      </Container>
      </Flex>
      <Container mt={{xl:"4%", lg:"3%"}}><br/>
